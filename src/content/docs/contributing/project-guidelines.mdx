...
4. **Logs** - Relevant log file contents (see [Troubleshooting](/mod-management/troubleshooting/#log-files))
5. **Screenshots** - If applicable

## Development Setup

See [Building from Source](/contributing/building-from-source/) for instructions on setting up the development environment.
