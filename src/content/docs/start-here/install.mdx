...
<PlatformBadges
  ...
  platforms={[
    ...
    { name: 'Linux', platform: 'linux', status: 'coming-soon', note: 'Planned' },
  ]}
/>

:::caution[macOS and Linux users]
LTK Manager is currently Windows-only. The cslol patcher stopped working on macOS, and a new macOS patcher is in development alongside a native macOS LTK Manager release, targeted for Q2/Summer 2026. Linux support is planned but has no release date yet.
:::
