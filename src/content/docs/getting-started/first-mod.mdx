...
- ltk-manager installed ([Installation guide](/getting-started/installation/))
- League of Legends installed and up to date
- A mod file in `.modpkg` or `.fantome` format

## Finding a Mod

Community mod sites and Discord servers are common sources for League mods. Mods are distributed as `.modpkg` (recommended) or `.fantome` (legacy) files.
...
- [Troubleshooting](/guides/mod-management/troubleshooting/) - Common issues and how to resolve them
