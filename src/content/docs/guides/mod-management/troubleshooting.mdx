...
LTK Manager does not yet support Linux. Linux support is planned but has no release date. Follow [LeagueToolkit on GitHub](https://github.com/LeagueToolkit) for updates.
