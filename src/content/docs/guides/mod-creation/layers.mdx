...
String overrides are layer-specific, so different layers can provide different text. See [String Overrides](/guides/mod-creation/string-overrides/) for the full editing guide.
