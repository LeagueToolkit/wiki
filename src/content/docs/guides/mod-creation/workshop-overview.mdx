...
- Configure layers
- Edit [string overrides](/guides/mod-creation/string-overrides/) to change in-game text
...
- [String Overrides](/guides/mod-creation/string-overrides/) - Editing in-game text
