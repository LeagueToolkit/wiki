...
tags:
  type: concept
  audience: [mod-user]
  subject: [patcher, overlay, ltk-manager]
---
...
- Check the [log file](/mod-management/troubleshooting/#log-files) for errors
...
This is why [mod ordering](/mod-management/library/) matters - it determines which mod "wins" when there's a conflict.

### Profiles and Overlays

Each [profile](/mod-management/profiles/) maintains its own separate overlay directory. When you switch profiles, you're not just swapping a list of enabled mods - you're switching to an entirely different set of built overlay files.
